...
import Project_Statuses_Create from "@/views/projects/statuses/Project_Statuses_Create.vue";
import Project_Statuses_Edit from "@/views/projects/statuses/Project_Statuses_Edit.vue";

export default {
  name: "Project_Statuses",
  components: {
    'project_statuses_create' : Project_Statuses_Create,
    'project_statuses_edit' : Project_Statuses_Edit,
